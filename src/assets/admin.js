...
function init_aspect_ratio_handler(moduleElement) {


	function updateAspectRatio() {
		const ratio = aspectRatioField.value;
		imageWrap.style.removeProperty('aspect-ratio');
		const cssRatio = ratio.replace(':', '/');
		imageWrap.style['--aspect-ratio'] = cssRatio;
	}
	...
	// Update on change
	aspectRatioField.addEventListener('change', updateAspectRatio);
}
